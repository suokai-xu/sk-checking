...
import com.sk.colud.exception.CmsException;
import com.sk.colud.mapper.BaseMapper;
...
public class BaseServiceClientImpl implements BaseServiceClient {
    ...
    private Map<String, Object> transformObj(Object t, String type) {
        ...
        re.put("TABLE_NAME", t.getClass().getAnnotation(Table.class).name());
        ...
        if ("insert".equals(type)) {
            ...
            for (Method i : m) {
                ...
                if (null != i.getAnnotation(Column.class)) {
                    k.add(i.getAnnotation(Column.class).name());
            ...
            for (Method i : m) {
                ...
                if (null != i.getAnnotation(Column.class) && null != getInvokeValue(t, i)) {
                    map.put("COLUMN", i.getAnnotation(Column.class).name());
